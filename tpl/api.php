<?php
	...
	function oldTransactionReport(){
		...
		$getTransactionsQueryAdmin = "SELECT Administrator.FIRSTNAME, Administrator.LASTNAME, User.USER_EMAIL, Inventory.ISBN_NUMBER, Book.TITLE, TransactionsArchive.RETURN_DATE FROM User INNER JOIN Administrator ON User.USER_ID = Administrator.USER_ID INNER JOIN TransactionsArchive ON User.USER_ID = TransactionsArchive.USER_ID INNER JOIN Inventory ON TransactionsArchive.INVENTORY_ID = Inventory.INVENTORY_ID INNER JOIN Book ON Inventory.ISBN_NUMBER = Book.ISBN_NUMBER;";
		...
		$getTransactionTeacherQuery = "SELECT Teacher.FIRSTNAME, Teacher.LASTNAME, User.USER_EMAIL, Inventory.ISBN_NUMBER, Book.TITLE, TransactionsArchive.RETURN_DATE FROM User INNER JOIN Teacher ON User.USER_ID = Teacher.USER_ID INNER JOIN TransactionsArchive ON User.USER_ID = TransactionsArchive.USER_ID INNER JOIN Inventory ON TransactionsArchive.INVENTORY_ID = Inventory.INVENTORY_ID INNER JOIN Book ON Inventory.ISBN_NUMBER = Book.ISBN_NUMBER;";
		...
		$getTransactionStudentQuery = "SELECT Student.FIRSTNAME, Student.LASTNAME, User.USER_EMAIL, Inventory.ISBN_NUMBER, Book.TITLE, TransactionsArchive.RETURN_DATE FROM User INNER JOIN Student ON User.USER_ID = Student.USER_ID INNER JOIN TransactionsArchive ON User.USER_ID = TransactionsArchive.USER_ID INNER JOIN Inventory ON TransactionsArchive.INVENTORY_ID = Inventory.INVENTORY_ID INNER JOIN Book ON Inventory.ISBN_NUMBER = Book.ISBN_NUMBER;";
